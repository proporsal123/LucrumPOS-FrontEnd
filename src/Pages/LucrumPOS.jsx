                    ...
                    <div className='px-5 py-2 border-r border-b border-l mt-3 border-gray-100 shadow-md w-220 h-[80vh]'>
                        ...
                        <div className='grid grid-cols-3 text-gray-600 my-10 gap-y-10 gap-10 '>
                            <div className=''>
                                ...
                                <p className='flex items-center hover:text-black transition-all gap-1'>Depository <ArrowUpRight strokeWidth={1.6} className='w-4 h-4' /> </p>
                            </div>
                            <div className=''>
                                <h1 className='font-semibold mb-3 text-black'>Profile</h1>
                                <p className='flex items-center cursor-pointer hover:text-black transition-all gap-1'>POS Profile <ArrowUpRight strokeWidth={1.6} className='w-4 h-4' /> </p>
                            </div>
                            <div className=''>
                                <h1 className='font-semibold mb-3 text-black'>Shift</h1>
                                <p className='flex items-center cursor-pointer hover:text-black transition-all gap-1'>Opening Shift <ArrowUpRight strokeWidth={1.6} className='w-4 h-4' /> </p>
                                <p className='flex items-center cursor-pointer hover:text-black transition-all gap-1'>Closing Shift <ArrowUpRight strokeWidth={1.6} className='w-4 h-4' /> </p>
                            </div>
