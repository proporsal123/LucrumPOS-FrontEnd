        ...
        <div className='mr-10 py-2 border-r border-b border-l mt-3 border-gray-200 flex-1 min-h-[70vh]'>
          <div className='flex items-start border-b pb-4 border-gray-200 justify-between'>
            <div className='flex flex-wrap gap-2 pl-5 w-140 items-center'>
              ...
              <input className='bg-gray-200 w-28 outline-none rounded-md pl-2 py-1' type="text" placeholder='Title' />
              <input className='bg-gray-200 w-28 outline-none rounded-md pl-2 py-1' type="text" placeholder='Branch' />
              <div className='bg-gray-200 max-w-28 relative rounded-md pl-2 py-1'>
                <input className=' outline-none ' type="text" placeholder='Purpose' />
                <ChevronsUpDown className='w-3 h-3 absolute top-2 right-2 fill-black text-black' />
              </div>
              <input className='bg-gray-200 w-28 truncate outline-none rounded-md pl-2 py-1' type="text" placeholder='Company' />
              <div className='bg-gray-200 max-w-28 relative rounded-md pl-2 py-1'>
                <input className=' outline-none ' type="text" placeholder='Status' />
                <ChevronsUpDown className='w-3 h-3 absolute top-2 right-2 fill-black text-black' />
              </div>
            </div>
