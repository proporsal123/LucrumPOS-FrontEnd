            ...
            <div className="flex">
                ...
                <div className='px-5 py-2 border-r border-b border-l mt-3 border-gray-100 shadow-md w-220 h-[70vh]'>
                        ...
                        <div className='grid grid-cols-4 text-gray-600 my-5 gap-y-5 gap-2'>
                            ...
                            <div onClick={()=> navigate('/workplace/closing-shift')} className='flex gap-1 cursor-pointer items-center' >
                                POS Shift Closed
                                <ArrowUpRight strokeWidth={1.6} className='w-4 h-4' />
                                <div className='bg-gray-100 px-3 py-1 rounded-2xl'>1</div>
                            </div>
                            <div onClick={()=> navigate('/workplace/opening-shift')} className='flex gap-1 cursor-pointer items-center' >
                                Opening Shift
                                <ArrowUpRight strokeWidth={1.6} className='w-4 h-4' />
                                <div className='bg-gray-100 px-3 py-1 rounded-2xl'>1</div>
                            </div>
                            <div onClick={()=> navigate('/workplace/demand')} className='flex gap-1 cursor-pointer items-center' >
                                Demand
                                <ArrowUpRight strokeWidth={1.6} className='w-4 h-4' />
                                <div className='bg-gray-100 px-3 py-1 rounded-2xl'>3</div>
                            </div>
                            <div onClick={()=> navigate('/workplace/depository')} className='flex gap-1 cursor-pointer items-center' >
                                Depository
                                <ArrowUpRight strokeWidth={1.6} className='w-4 h-4' />
                                <div className='bg-gray-100 px-3 py-1 rounded-2xl'>0</div>
                            </div>
                            <div onClick={()=> navigate('/workplace/rejection-entry')} className='flex gap-1 cursor-pointer items-center' >
                                Rejection Entry
                                <ArrowUpRight strokeWidth={1.6} className='w-4 h-4' />
                                <div className='bg-gray-100 px-2.5 py-1 rounded-2xl'>530</div>
                            </div>
                            <div onClick={()=> navigate('/workplace/stock-take')} className='flex gap-1 cursor-pointer items-center' >
                                Stock Take
                                <ArrowUpRight strokeWidth={1.6} className='w-4 h-4' />
