  ...
  return (
    <div className='flex items-center gap-6'>
                <div className='flex items-center w-full max-w-210 justify-between p-2 rounded-lg shadow-lg bg-white'>
                    ...
                    <div className='flex gap-3 items-center'>
                        <div className='relative'>
                            ...
                            <ChevronDown  className='w-4 h-4 absolute text-gray-400 top-4 right-2'/>
                            <p className='absolute -top-1.5 text-gray-400 bg-white text-[10px] left-1.5 '>Order Type</p>
                        </div>
                        <div className='relative'>
                            <input className='w-75 py-2.5 px-2 border border-gray-400 rounded-lg outline-none ' type="text" placeholder='Find your Item' /> <Search className='absolute text-gray-400 w-4 h-4 top-4 right-3' />
                        </div>
                    </div>
                </div>
                <div className='w-110 flex items-center gap-20'>
                    ...
                    <button onClick={()=>navigate('/workspace/lucrum-pos')} className='flex w-36 items-center px-2 py-2 border rounded-lg border-red-400 gap-2 bg-red-300'>
